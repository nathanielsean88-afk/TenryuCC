...
export async function POST(req: NextRequest) {
  try {
    ...
    const { nama, ccSebelumnya, alasanKeluar, alasanMasuk, tiktok, discord, whatsapp, umur, asalKota, clerkUserId } = body
    ...
    // Prioritaskan clerkUserId dari body (client-side), fallback ke server auth
