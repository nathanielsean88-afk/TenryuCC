...
export default function RegisterPage() {
  return (
    <div style={{
      ...
      <div className="register-wrapper" style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: 480, padding: '0 24px' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 className="register-title" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 36, fontWeight: 300, color: 'var(--snow)', marginBottom: 8 }}>
            Buat Akun
          </h1>
